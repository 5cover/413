...
$new_state     = getarg($_GET, 'new_state', arg_filter(FILTER_VALIDATE_BOOL), required: false);
...
$stmt = DB\connect()->prepare("update _avis set dislikes=dislikes+?,likes=likes+? where id_avis=?");
DB\bind_values($stmt, [
